...
# Add the meta-skeleton layer
cd ${PRJ_BUILD_DIR}
RUN_CMD="bitbake-layers add-layer ${SRC_WRL_DIR}/layers/oe-core/meta-skeleton"
echo_cmd "Add the meta-skeleton layer into the build project"
${RUN_CMD}
