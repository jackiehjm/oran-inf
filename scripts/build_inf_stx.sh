...
SRC_YP_URL="\
    ...
    https://github.com/intel-iot-devkit/meta-iot-cloud;commit=HEAD \
    git://git.openembedded.org/meta-python2;commit=HEAD \
    https://git.yoctoproject.org/git/meta-dpdk;commit=HEAD \
...
add_layer_anaconda_build () {
    ...
    SRC_LAYERS="${SRC_LAYERS} ${SRC_LAYER_DIR}/meta-starlingx/meta-stx-distro"
    SRC_LAYERS="${SRC_LAYERS} ${SRC_LAYER_DIR}/meta-starlingx/meta-stx-integ"
